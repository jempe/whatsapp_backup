...
func (app *application) createAuthenticationTokenHandler(w http.ResponseWriter, r *http.Request) {
	...
	token, err := app.models.Tokens.New(user.ID, tokenDuration, data.ScopeAuthentication)
	if err != nil {
		app.serverErrorResponse(w, r, err)
		return
	}
	...
	app.background(func() {
		...
		if err != nil {
			app.logger.PrintError(err, map[string]string{
				"method": "createPasswordResetTokenHandler",
...
func (app *application) createActivationTokenHandler(w http.ResponseWriter, r *http.Request) {
	...
	app.background(func() {
		...
		if err != nil {
			app.logger.PrintError(err, map[string]string{
				"method": "createActivationTokenHandler",
				"action": "sending activation email",
			})
		}
	})
